...
class TopicSpider(scrapy.Spider):
    ...
    def start_scrap(self, response):
        sitemap_url = "https://premium.oxforddictionaries.com/sitemap/english/sitemap{}.xml"

        for i in range(10):
            yield scrapy.Request(sitemap_url.format(i+1), self.parse_sitemap)
    ...
    def parse(self, response):
        filename = "premiums/" + response.url.split("/")[-1] + '.html'
